...
프링글스 통 그 잡채다. Last In, First Out

**Queue**

단순 통로, 들어온 대로 나간다. First In, First Out
...
![Screenshot 2026-08-07 at 3.34.01 PM.png](Screenshot_2026-08-07_at_3.34.01_PM.png)

- 아래에서 위로 차곡차곡 쌓고, 아래에 있는 것을 꺼내기 위해선 위에 있는 것들부터 먼저 꺼내야함
- First In Last Out 또는 Last In First Out

---

# Queue

![Screenshot 2026-08-07 at 3.34.26 PM.png](Screenshot_2026-08-07_at_3.34.26_PM.png)

- 양쪽 구멍이 다 뚫려 있어서 넣는 순서 그대로 나옴
- First In First Out
- 파이썬에선 queue말고 collections.deque를 선언해서 popleft()로 queue같이 쓰면 됨
